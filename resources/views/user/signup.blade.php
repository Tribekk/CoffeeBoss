            ...
            <div class="col-lg-4">
                <form method="post" action="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <img class="mb-4" src="../picture/image0.png" alt="" width="100" height="100" style="background-color: white; border-radius: 50%">
                        </div>
                    </div>
                    ...
                    <div class="container">
                        <a href="{{route('user.login')}}" class="link mt-5">Вход</a>
                    </div>
                </form>
            </div>
        </div>
